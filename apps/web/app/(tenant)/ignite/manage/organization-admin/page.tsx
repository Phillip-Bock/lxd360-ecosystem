...
const orgAdminSections = [
  {
    ...
    href: '/(tenant)/ignite/manage/organization-admin/users',
    icon: Users,
  },
  {
    title: 'Branding',
    description: 'Customize your organization appearance',
    href: '/(tenant)/ignite/manage/organization-admin/branding',
    icon: Palette,
  },
  {
    title: 'Billing',
    description: 'Manage subscription and payments',
    href: '/(tenant)/ignite/manage/organization-admin/billing',
    icon: CreditCard,
  },
  {
    title: 'Settings',
    description: 'Configure organization settings',
    href: '/(tenant)/ignite/manage/organization-admin/settings',
    icon: Settings,
  },
];
