...
const teachNavItems = [
  {
    label: 'Dashboard',
    href: '/03-lxd360-inspire-ignite/teach/dashboard',
    icon: LayoutDashboard,
  },
  {
    label: 'Gradebook',
    href: '/03-lxd360-inspire-ignite/teach/gradebook',
    icon: GraduationCap,
  },
  {
    label: 'Courses',
    href: '/03-lxd360-inspire-ignite/teach/courses',
    icon: BookOpen,
  },
  {
    label: 'Learners',
    href: '/03-lxd360-inspire-ignite/teach/learners',
    icon: Users,
  },
  {
    label: 'Analytics',
    href: '/03-lxd360-inspire-ignite/teach/analytics',
    icon: BarChart3,
  },
  {
    label: 'Settings',
    href: '/03-lxd360-inspire-ignite/teach/settings',
    icon: Settings,
  },
];
