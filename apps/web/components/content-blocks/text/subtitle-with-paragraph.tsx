...
export function SubtitleWithParagraph(): React.JSX.Element {
  ...
  return (
    <div className="bg-lxd-dark-page border border-lxd-dark-surface rounded-xl shadow-lg p-10 w-full">
      <h2
        ...
        className="text-[1.75em] font-semibold text-lxd-blue m-0 mb-5 p-2.5 outline-hidden border-2 border-transparent transition-[border-color] duration-300 focus:border-lxd-blue"
      >
      ...
      <div
        ...
        style={{
          color:
            subtitleCharCount >= maxSubtitleChars
              ? 'var(--color-lxd-error)'
