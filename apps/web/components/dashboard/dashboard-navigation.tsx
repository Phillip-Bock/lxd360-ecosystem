...
import { CourseTypeModal } from '@/components/dashboard/course-type-modal';
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg transition-colors group text-left ${
                          isItemActive ? 'text-brand-primary' : 'text-sidebar-foreground'
                        }`}
                        style={isItemActive ? { backgroundColor: 'var(--lxd-blue-light)' } : {}}
                        onMouseEnter={(e) => {
                          if (!isItemActive) {
                      ...
                      >
                        <IconComponent
                          className={`w-5 h-5 ${isItemActive ? 'text-brand-primary' : 'text-muted-foreground'}`}
                        />
