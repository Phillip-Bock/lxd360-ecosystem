...
function SidebarContent({ user, pathname, onLinkClick }: SidebarContentProps): React.JSX.Element {
  return (
...
export function AdminSidebar({ user }: AdminSidebarProps): React.JSX.Element {
      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        ...
        <SheetContent side="left" className="w-64 p-0">
          <SidebarContent
            user={user}
            pathname={pathname}
            onLinkClick={(): void => setMobileOpen(false)}
          />
        </SheetContent>
      </Sheet>
    </>
