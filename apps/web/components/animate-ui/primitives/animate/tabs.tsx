...
function TabsHighlight({
  ...
  ...props
}: TabsHighlightProps): React.JSX.Element {
...
function TabsList(props: TabsListProps): React.JSX.Element {
...
function TabsHighlightItem(props: TabsHighlightItemProps): React.JSX.Element {
...
function TabsTrigger({
  ...
  React.useEffect(() => {
    ...
    return (): void => registerTrigger(value, null);
