...
function ActivityItem({ statement, showTimestamp }: ActivityItemProps): React.JSX.Element {
...
function ConnectionIndicator({ connected }: { connected: boolean }): React.JSX.Element {
  return (
    <div
      className={cn(
