...
export const StepsBar = ({ className, ...props }: StepsBarProps): React.ReactElement => (
...
export function Steps({ defaultOpen = true, className, ...props }: StepsProps): React.ReactElement {
