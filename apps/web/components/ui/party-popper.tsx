...
const PartyPopperIcon = forwardRef<PartyPopperIconHandle, PartyPopperIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    useImperativeHandle(ref, (): PartyPopperIconHandle => {
      isControlledRef.current = true;

      return {
        startAnimation: (): void => void controls.start('animate'),
        stopAnimation: (): void => void controls.start('normal'),
      };
    });
    ...
    return (
      ...
      >
        ...
        >
          <motion.path d="M5.8 11.3 2 22l10.7-3.79" variants={POPPER_VARIANTS} animate={controls} />
          <motion.path
            d="M11 13c1.93 1.93 2.83 4.17 2 5-.83.83-3.07-.07-5-2-1.93-1.93-2.83-4.17-2-5 .83-.83 3.07.07 5 2Z"
            variants={POPPER_VARIANTS}
            animate={controls}
          />
          <motion.path d="M4 3h.01" variants={DOTS_VARIANTS} animate={controls} />
          <motion.path d="M22 8h.01" variants={DOTS_VARIANTS} animate={controls} />
          <motion.path d="M15 2h.01" variants={DOTS_VARIANTS} animate={controls} />
          <motion.path d="M22 20h.01" variants={DOTS_VARIANTS} animate={controls} />
          <motion.path
