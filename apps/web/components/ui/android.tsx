...
export function Android({
  ...
  videoSrc,
  ...props
}: AndroidProps): React.JSX.Element {
  return (
    <svg
      aria-hidden="true"
      width={width}
    ...
    >
      <path
        ...
        className="fill-lxd-light-border dark:fill-muted-foreground"
      />
      <path
      ...
      <path
        ...
        className="fill-white dark:fill-muted-foreground"
      />
      ...
      <g clipPath="url(#clip0_514_20855)">
        <path
          ...
          className="fill-lxd-light-border stroke-lxd-light-border stroke-[0.5] dark:fill-muted-foreground dark:stroke-muted-foreground"
        />
      </g>
      <circle cx="189" cy="28" r="9" className="fill-white dark:fill-muted-foreground" />
      <circle cx="189" cy="28" r="4" className="fill-lxd-light-border dark:fill-muted-foreground" />
      {src && (
        <image
          href={src}
          width="360"
