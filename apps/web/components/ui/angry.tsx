...
const AngryIcon = forwardRef<AngryIconHandle, AngryIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    useImperativeHandle(ref, (): AngryIconHandle => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          />
          <motion.path variants={PATH_VARIANTS_LEFT_EYEBROW} animate={controls} d="M7.5 8 10 9" />
          <motion.path variants={PATH_VARIANTS_RIGHT_EYEBROW} animate={controls} d="m14 9 2.5-1" />
          <motion.path variants={PATH_VARIANTS_EYE} animate={controls} d="M9 10h.01" />
          <motion.path variants={PATH_VARIANTS_EYE} animate={controls} d="M15 10h.01" />
        </motion.svg>
      </div>
    );
  },
