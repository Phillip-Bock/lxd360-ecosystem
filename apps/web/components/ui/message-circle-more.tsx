...
const MessageCircleMoreIcon = forwardRef<MessageCircleMoreIconHandle, MessageCircleMoreIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    useImperativeHandle(ref, (): MessageCircleMoreIconHandle => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <motion.path d="M8 12h.01" variants={DOT_VARIANTS} animate={controls} custom={0} />
          <motion.path d="M12 12h.01" variants={DOT_VARIANTS} animate={controls} custom={1} />
          <motion.path d="M16 12h.01" variants={DOT_VARIANTS} animate={controls} custom={2} />
        </svg>
      </div>
    );
  },
