    ...
    return (
      ...
      >
        <motion.svg
          ...
          animate={svgControls}
        >
          <motion.path d="m5 8 6 6" variants={PATH_VARIANTS} custom={3} animate={pathControls} />
          <motion.path
            d="m4 14 6-6 3-3"
          ...
          />
          <motion.path d="M2 5h12" variants={PATH_VARIANTS} custom={1} animate={pathControls} />
          <motion.path d="M7 2h1" variants={PATH_VARIANTS} custom={0} animate={pathControls} />
          <motion.path
            d="m22 22-5-10-5 10"
            variants={PATH_VARIANTS}
            custom={3}
            animate={pathControls}
          />
          <motion.path d="M14 18h6" variants={PATH_VARIANTS} custom={3} animate={pathControls} />
        </motion.svg>
      </div>
    );
  },
