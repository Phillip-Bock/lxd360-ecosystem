...
>(({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
  ...
  useImperativeHandle(ref, (): GalleryVerticalEndIconHandle => {
  ...
  return (
    ...
    >
      ...
      >
        <motion.path d="M7 2h10" variants={PATH_VARIANTS} animate={controls} custom={1} />
        <motion.path d="M5 6h14" variants={PATH_VARIANTS} animate={controls} custom={2} />
