...
const ScanTextIcon = forwardRef<ScanTextIconHandle, ScanTextIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    useImperativeHandle(ref, (): ScanTextIconHandle => {
      ...
      return {
        ...
        stopAnimation: (): void => void controls.start('visible'),
      };
    });
    ...
    return (
      ...
      >
        ...
        >
          ...
          <motion.path variants={FRAME_VARIANTS} d="M21 17v2a2 2 0 0 1-2 2h-2" />
