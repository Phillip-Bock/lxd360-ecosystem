...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  // Store props in refs for use in animation loop
  ...
  const drawCircle = useCallback(
    (circle: Circle, update = false) => {
      if (context.current) {
        ...
        const currentRgb = hexToRgb(propsRef.current.color);
  ...
  const animate = useCallback(() => {
    ...
    circles.current.forEach((circle: Circle, i: number) => {
      ...
      circle.translateX +=
        (mouse.current.x / (currentStaticity / circle.magnetism) - circle.translateX) / currentEase;
      circle.translateY +=
        (mouse.current.y / (currentStaticity / circle.magnetism) - circle.translateY) / currentEase;
  ...
  }, [clearContext, remapValue, drawCircle, circleParams]);
  ...
  }, [initCanvas, animate, onMouseMove]);
