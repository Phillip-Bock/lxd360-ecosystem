    ...
    return (
      ...
      >
        ...
        >
          ...
          <motion.path d="M2 12a10 10 0 0 1 18-6" variants={PATH_VARIANTS} animate={controls} />

          <path d="M2 16h.01" strokeOpacity={0.4} strokeWidth="2" fill="none" />
          <motion.path d="M2 16h.01" variants={PATH_VARIANTS} animate={controls} />
          ...
          <motion.path d="M9 6.8a6 6 0 0 1 9 5.2v2" variants={PATH_VARIANTS} animate={controls} />
        </svg>
      </div>
    );
  },
