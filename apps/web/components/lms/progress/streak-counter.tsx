...
export function StreakCounter({
  ...
  variant = 'default',
  className,
}: StreakCounterProps): React.JSX.Element {
    ...
    return (
      <div
        className={cn(
          ...
          'bg-[var(--studio-bg)] border-[var(--lxd-dark-surface-alt)]/50',
          className,
        )}
      >
        ...
        <div className="flex items-center gap-1 mt-4 pt-4 border-t border-[var(--lxd-dark-surface-alt)]/50">
