...
export const ASSETS: DemoAsset[] = [
  {
    ...
    description: 'A Blender Foundation short film, protected by Widevine encryption',
  ...
  },
  {
    ...
    poster: 'https://storage.googleapis.com/shaka-asset-icons/big_buck_bunny.png',
                ...
                <div className="flex w-full items-center gap-3 p-2">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {isCurrentAsset && <div className="flex size-2 rounded-full bg-primary" />}
                    </div>
                    {asset.description && (
