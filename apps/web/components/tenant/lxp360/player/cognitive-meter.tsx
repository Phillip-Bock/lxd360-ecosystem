...
export function CognitiveMeter({
  ...
  return (
    <div
      className={cn(
        'bg-(--color-bg-secondary) rounded-xl border border-(--color-border)/50 p-4',
        className,
      )}
    >
      {/* Header */}
      ...
      {/* Progress bar */}
      <div className="relative h-2 bg-(--color-border)/30 rounded-full overflow-hidden mb-4">
        <div
        ...
        <div className="absolute inset-0 flex">
          <div className="flex-1 border-r border-(--color-bg-tertiary)" /> {/* 0-30: Fresh */}
          <div className="flex-1 border-r border-(--color-bg-tertiary)" /> {/* 30-60: Engaged */}
          <div className="flex-1 border-r border-(--color-bg-tertiary)" /> {/* 60-80: Working */}
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="bg-(--color-bg-tertiary) rounded-lg p-2">
