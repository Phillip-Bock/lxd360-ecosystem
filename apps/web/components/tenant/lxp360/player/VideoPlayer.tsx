  ...
  return (
    ...
    >
      ...
      {!isPlaying && (
        ...
        >
          <span className="w-20 h-20 rounded-full bg-(--lxd-blue-light)/90 flex items-center justify-center hover:bg-(--lxd-blue-light) transition-colors">
        ...
        >
          ...
          <div
            ...
            style={{
              width: `${progress}%`,
              background:
                'linear-gradient(to right, var(--lxd-blue-light), var(--brand-secondary))',
            }}
          />
          {/* Hover indicator */}
          <div
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={togglePlay}
              className="text-brand-primary hover:text-(--lxd-blue-light) transition-colors"
            >
            ...
            <div className="flex items-center gap-2 group/volume">
              ...
              <input
                ...
                className="w-0 group-hover/volume:w-20 transition-all duration-200 accent-(--lxd-blue-light)"
              />
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="text-brand-primary hover:text-(--lxd-blue-light) transition-colors flex items-center gap-1"
              >
              ...
              {showSettings && (
                <>
                  ...
                  />
                  <div className="absolute bottom-full right-0 mb-2 bg-studio-bg border border-(--lxd-blue-dark-700)/50 rounded-lg overflow-hidden z-50">
                    <div className="px-3 py-2 border-b border-(--lxd-blue-dark-700)/50 text-xs text-muted-foreground">
                      Playback Speed
                    </div>
                    {speedOptions.map((speed) => (
                      <button
                        ...
                        className={cn(
                          'w-full px-4 py-2 text-sm text-left hover:bg-(--lxd-blue-dark-700)/30 transition-colors',
                          playbackSpeed === speed
                            ? 'text-(--lxd-blue-light) bg-(--lxd-blue-light)/10'
                            : 'text-brand-primary',
                        )}
                      >
                        {speed}x
