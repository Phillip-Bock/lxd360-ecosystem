...
import type { BlockStyleConfig } from './block-style-presets';
import type { ColorPalette } from './color-palette-manager';
import type { TypographyConfig } from './typography-manager';
