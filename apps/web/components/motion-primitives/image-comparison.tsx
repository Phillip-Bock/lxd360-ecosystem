...
const ImageComparisonImage = ({
  ...
  if (!context) throw new Error('ImageLayer must be used within ImageComparisonProvider');
  ...
  return (
    // biome-ignore lint/performance/noImgElement: motion.img required for framer-motion animations
    <motion.img
      src={src}
      alt={alt}
