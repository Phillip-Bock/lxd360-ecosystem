...
function DialogTrigger({ children, className }: DialogTriggerProps): React.JSX.Element {
...
}: DialogPortalProps): React.ReactNode | null {
...
function DialogContent({ children, className, container }: DialogContentProps): React.JSX.Element {
  const context = useContext(DialogContext);
...
function DialogHeader({ children, className }: DialogHeaderProps): React.JSX.Element {
...
function DialogTitle({ children, className }: DialogTitleProps): React.JSX.Element {
  const context = useContext(DialogContext);
...
function DialogDescription({ children, className }: DialogDescriptionProps): React.JSX.Element {
  const context = useContext(DialogContext);
...
function DialogClose({ className, children, disabled }: DialogCloseProps): React.JSX.Element {
  const context = useContext(DialogContext);
