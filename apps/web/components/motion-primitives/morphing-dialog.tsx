...
function useMorphingDialog(): MorphingDialogContextType {
...
function MorphingDialogProvider({
  children,
  transition,
}: MorphingDialogProviderProps): React.JSX.Element {
...
function MorphingDialog({ children, transition }: MorphingDialogProps): React.JSX.Element {
  return (
...
function MorphingDialogContainer({
  children,
}: MorphingDialogContainerProps): React.ReactNode | null {
...
function MorphingDialogImage({
  ...
  className,
  style,
}: MorphingDialogImageProps): React.JSX.Element {
  const { uniqueId } = useMorphingDialog();

  return (
    // biome-ignore lint/performance/noImgElement: motion.img required for framer-motion layout animations
    <motion.img
      src={src}
      alt={alt}
