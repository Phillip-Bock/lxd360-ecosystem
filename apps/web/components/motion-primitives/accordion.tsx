...
function AccordionProvider({
  ...
  onValueChange,
}: AccordionProviderProps): React.JSX.Element {
  ...
  const toggleItem = (value: React.Key): void => {
...
function AccordionItem({ value, children, className }: AccordionItemProps): React.JSX.Element {
