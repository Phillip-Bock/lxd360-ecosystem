...
export function ScrollVelocityRow(props: ScrollVelocityRowProps): React.ReactElement {
...
function ScrollVelocityRowImpl({
  ...
  velocityFactor,
  ...props
}: ScrollVelocityRowImplProps): React.ReactElement {
...
function ScrollVelocityRowLocal(props: ScrollVelocityRowProps): React.ReactElement {
  const { scrollY } = useScroll();
