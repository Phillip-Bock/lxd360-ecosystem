...
const ShowerHeadIcon = forwardRef<ShowerHeadIconHandle, ShowerHeadIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    useImperativeHandle(ref, (): ShowerHeadIconHandle => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <path d="M15 5 5 15" />
          <motion.g variants={DROP_VARIANTS} animate={controls} initial="normal">
            {DROP_PATH.map((path) => (
              <motion.path variants={DROP_CHILD_VARIANTS} key={path.id} d={path.d} />
            ))}
          </motion.g>
        </svg>
      </div>
