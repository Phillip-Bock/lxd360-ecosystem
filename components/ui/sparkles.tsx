    ...
    return (
      ...
      >
        ...
        >
          ...
          />
          <motion.path d="M20 3v4" variants={STAR_VARIANTS} animate={starControls} />
          <motion.path d="M22 5h-4" variants={STAR_VARIANTS} animate={starControls} />
          <motion.path d="M4 17v2" variants={STAR_VARIANTS} animate={starControls} />
          <motion.path d="M5 18H3" variants={STAR_VARIANTS} animate={starControls} />
        </svg>
      </div>
    );
  },
