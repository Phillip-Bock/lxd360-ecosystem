...
const HandCoinsIcon = forwardRef<HandCoinsIconHandle, HandCoinsIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    useImperativeHandle(ref, (): HandCoinsIconHandle => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <path d="m2 16 6 6" />
          <motion.circle cx="16" cy="9" r="2.9" animate={controls} variants={CIRCLE_VARIANTS} />
          <motion.circle cx="6" cy="5" r="3" animate={controls} variants={SECOND_CIRCLE_VARIANTS} />
        </svg>
      </div>
    );
  },
