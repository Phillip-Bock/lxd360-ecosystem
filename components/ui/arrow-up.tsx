...
const ArrowUpIcon = forwardRef<ArrowUpIconHandle, ArrowUpIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    useImperativeHandle(ref, (): ArrowUpIconHandle => {
    ...
    return (
      ...
      >
        ...
        >
          <motion.path d="m5 12 7-7 7 7" variants={PATH_VARIANTS} animate={controls} />
          <motion.path d="M12 19V5" variants={SECOND_PATH_VARIANTS} animate={controls} />
        </svg>
      </div>
    );
  },
