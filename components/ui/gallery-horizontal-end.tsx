...
>(({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
  ...
  useImperativeHandle(ref, (): GalleryHorizontalEndIconHandle => {
  ...
  return (
    ...
    >
      ...
      >
        <motion.path d="M6 5v14" variants={PATH_VARIANTS} animate={controls} custom={2} />
        <motion.path d="M2 7v10" variants={PATH_VARIANTS} animate={controls} custom={1} />
