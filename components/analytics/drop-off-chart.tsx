...
export function DropOffChart({
  ...
  loading = false,
  className,
}: DropOffChartProps): React.JSX.Element {
...
export function CompletionFunnel({
  ...
  loading = false,
  className,
}: CompletionFunnelProps): React.JSX.Element {
...
function FunnelStep({
  ...
  isFirst,
  previousValue,
}: FunnelStepProps): React.JSX.Element {
...
export function DropOffIndicators({
  points,
  limit = 5,
  className,
}: DropOffIndicatorsProps): React.JSX.Element {
