...
function AccordionItem(props: AccordionItemProps): React.JSX.Element {
...
function AccordionHeader(props: AccordionHeaderProps): React.JSX.Element {
  return <AccordionPrimitive.Header data-slot="accordion-header" {...props} />;
}

type AccordionTriggerProps = React.ComponentProps<typeof AccordionPrimitive.Trigger>;

function AccordionTrigger(props: AccordionTriggerProps): React.JSX.Element {
