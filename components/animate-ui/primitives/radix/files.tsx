...
function FilesHighlight({ hover = true, ...props }: FilesHighlightProps): React.JSX.Element {
  return (
...
function FolderItem({ value, ...props }: FolderItemProps): React.JSX.Element {
  const { open } = useFiles();
