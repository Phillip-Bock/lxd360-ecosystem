      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-3xl text-pretty text-lg text-gray-400">
            Organizations track completions—not competence. The result? Billions wasted on training
            that never transfers to the job.
            <span className="block mt-4 text-white font-medium">
              LXD360 was built to solve this with science-backed learning that actually works.
            </span>
          </p>
        </motion.div>
          ...
          <div className="relative rounded-2xl border border-blue-500/30 p-2 md:rounded-3xl md:p-3">
            ...
            <div className="rounded-xl bg-linear-to-br from-blue-950/50 to-gray-950 p-8 text-center">
              <p className="text-lg text-gray-300 mb-4">
                The L&D market is projected to grow from{' '}
                <span className="font-bold text-blue-400">$401B to $929B by 2030</span> at an{' '}
                <span className="font-bold text-blue-400">18.27% CAGR</span>.
              </p>
              <p className="text-gray-400">
                The LXP segment alone is growing at{' '}
                <span className="font-semibold text-white">33.8% CAGR</span>—the fastest in the
                industry.
              </p>
            </div>
          </div>
