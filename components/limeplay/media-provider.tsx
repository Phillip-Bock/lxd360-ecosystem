...
export function MediaProvider({
  ...
  return <MediaProviderContext.Provider value={store}>{children}</MediaProviderContext.Provider>;
}

function useMediaStoreWithContext<T>(selector: (state: TypeMediaStore) => T): T {
