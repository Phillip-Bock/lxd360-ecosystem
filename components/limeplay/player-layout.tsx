...
export const PlayerContainer = React.forwardRef<HTMLDivElement, PlayerContainerProps>(
...
export const ControlsTopContainer = React.forwardRef<HTMLDivElement, ControlsTopContainerProps>(
  ({ children, className, ...props }, ref) => {
    return (
      <div
        className={cn(
