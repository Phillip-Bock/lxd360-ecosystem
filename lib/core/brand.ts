/**
 * Brand System - references design-tokens.ts
 *
 * This file provides brand-specific utilities and style objects.
 * All color values are imported from design-tokens.ts which mirrors globals.css.
 *
 * IMPORTANT: globals.css is the SINGLE SOURCE OF TRUTH
 * Colors are sourced from design-tokens.ts -> globals.css
 */
